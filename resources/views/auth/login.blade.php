        ...
        <div class="account-content">
            ...
            <div class="container">
                ...
                <div class="account-logo">
                    <a href="index.html"><img src="{{ URL::to('tema/img/logo.png') }}" alt="PT.INFORMATIKA"></a>
                </div>
                {{-- message --}}
                {!! Toastr::message() !!}
                <!-- /Account Logo -->
                <div class="account-box">
                    <div class="account-wrapper">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group text-center">
                                <button class="btn btn-primary account-btn" type="submit"><a href="/beranda">Back To Home</a></button>
                            </div>
