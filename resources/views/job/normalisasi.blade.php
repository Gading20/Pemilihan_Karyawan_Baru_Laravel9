        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h3 class="page-title">Normalisasi</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped custom-table mb-0 datatable">
                            ...
                            <tbody>
                                @foreach ($normalisasi as $normalisasis)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $normalisasis->nama}}</td>
                                    <td>{{ $normalisasis->usia}}</td>
                                    <td>{{ $normalisasis->pengalaman_kerja}}</td>
                                    <td>{{ $normalisasis->ipk}}</td>
                                    <td>{{ $normalisasis->kesediaan_gaji}}</td>
                                    <td>{{ $normalisasis->jumlah_sertifikat}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
