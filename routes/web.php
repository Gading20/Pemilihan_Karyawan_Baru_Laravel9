...
//------------------------------- CRUD ADMIN ---------------------------------//
Route::resource('/dashboard/alternatifs', DashboardAlternatifController::class)->middleware(['auth']);
Route::resource('/dashboard/kriterias', DashboardKriteriaController::class)->middleware(['auth']);

#----------------------------------Normalisasi--------------------------------//
Route::get('/normalisasi', [SawController::class, 'sawnormalisasi']);

#----------------------------------Hasil-------------------------------------//
Route::get('/hasil', [SawController::class, 'sawhasil']);

#--------------------------------LandingPage--------------------------------//
Route::get('/job', [LandingPageController::class, 'job']);
Route::get('/beranda', [LandingPageController::class, 'beranda']);
